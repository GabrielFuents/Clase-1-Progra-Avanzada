...
namespace Practica2
{
    ...
    {
        private readonly Practica2Context _context;

        public ComidasController(Practica2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,HoraConsumo,Consumo,Total,Local,Empleado")] Comida comida)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,HoraConsumo,Consumo,Total,Local,Empleado")] Comida comida)
        {
            if (id != comida.Id)
            {
                return NotFound();
